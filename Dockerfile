...
WORKDIR /app/faceappapi-useruservice
...
RUN CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o faceappapi-useruservice
...
COPY --from=builder /app/faceappapi-useruservice/faceappapi-useruservice .
