...
import (
	...
	"github.com/DataInfosec/faceappapi/locationservice/utils/router"
)
...
func main() {
	...
	// resp, err1 := http.Get("https://tanda102.herokuapp.com/account/login?locationname=dirisujesse&password=qwerty&status=admin")
	// if err1 != nil {
	// 	log.Fatalln(err1)
	// }
